      ...
      async authorize(credentials) {
        ...
        try {
          ...
          if (isAdmin) {
            ...
            response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/admin/register`, {
            ...
            response = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/user/register`, {
